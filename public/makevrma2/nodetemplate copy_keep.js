    ...
    { "name": "spine", "r": [0, 0.2, -0.01], "sz": [0.08], "c": [
      { "name": "neck", "pts":[], "r": [0, 0.4, 0], "sz": [0.04], "c": [
        {"name":"head", "pts":[], "r": [0, 0.1, 0.01], "sz": [0.04], "c": [
          {"name": "jaw", "pts": [], "r": [0, -0.05, 0.05], "sz": [0.01], "c": []},
          ...
          {"name":"antenna0", "k": ["exc"], "pts":[], "r": [0.04, 0.04, -0.05], "sz":[0.02], "c":[
            {"name":"antenna1", "k": ["exc"], "pts":[], "r": [0, 0.04, -0.05], "sz": [0.01], "c":[
              {"name":"antenna2", "k": ["exc"], "pts": [], "r":[0, 0.04, -0.05], "sz": [0.01], "c": [
{"name":"antenna3", "k": ["exc"], "pts": [], "r":[0, 0.04, -0.05], "sz": [0.01], "c": [
  {"name":"antenna4", "k": ["exc"], "pts": [], "r":[0, 0.04, -0.05], "sz": [0.01], "c": [
    {"name":"antenna5", "k": ["exc"], "pts": [], "r":[0, 0.04, -0.05], "sz": [0.01], "c": [
{"name":"antenna6", "k": ["exc"], "pts": [], "r":[0, 0.04, -0.05], "sz": [0.01], "c": [
{"name":"antenna7", "k": ["exc"], "pts": [], "r":[0, 0.04, -0.05], "sz": [0.01], "c": [
{"name":"antenna8", "k": ["exc"], "pts": [], "r":[0, 0.04, -0.05], "sz": [0.01], "c": [
{"name":"antenna9", "k": ["exc"], "pts": [], "r":[0, 0.04, -0.05], "sz": [0.01], "c": [
]}
]}
]}
]}
          ...
          { "name": "leftUpperArm", "r": [0.1, 0, 0], "sz": [0.04], "c": [
              { "name": "leftLowerArm", "r": [0.3, 0, 0], "sz": [0.04], "c": [
                  ...
                  {"name": "leftTwist1", "r": [0, 0.4, 0], "sz": [0.06], "c": [
                    {"name": "antenna11", "k": ["exc"], "pts": [], "r": [0.4, 0, 0], "sz": [0.06], "c": [
                      {"name": "antenna12", "k": ["exc"], "pts": [], "r": [0.2, 0, 0], "sz": [0.06], "c": [
                        {"name": "leftTwist13", "r": [0.2, 0, 0], "sz": [0.06], "c": [
                          {"name": "leftTwist14", "r": [0.2, 0, 0], "sz": [0.06], "c": [
                            {"name": "leftTwist1End", "r": [0.2, 0, 0], "sz": [0.06], "c": []}
                          ]}
                        ]}
                      ]}
                    ]}
                  ...
                  { "name": "leftTwist4", "r": [0.2, 0.2, -0.2], "sz": [0.06], "c": [
                    {"name": "antenna41", "k": ["exc"], "r": [0, -0.2, 0], "sz": [0.06], "c": [
                      {"name": "antenna42", "k": ["exc"], "r": [0, -0.2, 0], "sz": [0.06], "c": [
                        {"name": "leftTwist43", "r": [0, -0.2, 0], "sz": [0.06], "c": [
                          {"name": "leftTwist4End", "r": [0, -0.2, 0], "sz": [0.06], "c": []}
                        ]}
                      ]}
                    ]}
                  ]}
