    ...
    {"name": "Armature", "k": ["exc"], "pts":[], "r": [0,0,0], "sz": [0.0], "c":[
        {"name": "hips", "r": [0, 0.5, 0], "sz": [0.08], "c":[
            { "name": "leftUpperLeg" , "bo": 0, "r": [-0.1, -0.06, -0.01], "c": [
                { "name": "leftLowerLeg", "r": [0, -0.2, 0], "c": [
                    { "name": "leftFoot", "r": [0, -0.16, 0], "sz": [0.03], "c": [
                        { "name": "leftToes", "pts":[], "r": [0, -0.05, -0.1], "sz": [0.02], "c":[
                            {"name": "leftToeEnd", "k": ["exc"], "pts":[], "r": [0,0, -0.05], "sz": [0.01]}
                        ]}
                    ]},
                ]},
            ]},
            { "name": "rightUpperLeg", "bo": 0, "r": [0.1, -0.06, -0.01], "c": [
                { "name": "rightLowerLeg", "r": [0, -0.2, 0], "c": [
                    { "name": "rightFoot", "r": [0, -0.16, 0], "sz": [0.03], "c": [
                        { "name": "rightToes", "pts":[], "r": [0, -0.05, -0.1], "sz": [0.02], "c": [
            ...
            { "name": "spine", "r": [0, 0.2, -0.01], "sz": [0.08], "c": [
                { "name": "neck", "bo": 0, "pts":[], "r": [0, 0.2, 0], "sz": [0.04], "c": [
                    {"name":"head", "pts":[], "r": [0, 0.1, -0.01], "sz": [0.04], "c": [
                        {"name":"leftEye", "bo": 0, "pts":[], "r": [-0.04, 0, -0.01], "sz": [0.01], "c": [
                ...
                {"name": "chest", "r": [0, 0.15, 0], "sz": [0.08], "c": [
                    {"name": "leftShoulder", "bo": 0, "pts":[], "r": [-0.1, 0, -0.01], "sz": [0.04], "c":[
                        { "name": "leftUpperArm", "r": [-0.1, 0, 0], "sz": [0.04], "c": [
                            { "name": "leftLowerArm", "r": [-0.15, 0, 0], "sz": [0.04], "c": [
                                { "name": "leftHand", "r": [-0.1, 0, 0], "sz": [0.025], "c": [
                                    { "name": "leftThumbProximal", "bo": 0, "pts":[], "r": [-0.05, 0, -0.02], "ci": [2,0,0], "sz": [0.015], "c": [
                                    ...
                                    { "name": "leftIndexProximal", "bo": 0, "pts":[], "r": [-0.095, 0, -0.025], "ci": [0,2,0], "sz": [0.008], "c": [
                                    ...
                                    { "name": "leftMiddleProximal", "bo": 0, "pts":[], "r": [-0.1, 0, -0], "ci": [0,0,2], "sz": [0.008], "c": [
                                    ...
                                    { "name": "leftRingProximal", "bo": 0, "pts":[], "r": [-0.09, 0, 0.02], "ci": [2,1,0], "sz": [0.008], "c": [
                    ...
                    {"name": "rightShoulder", "bo": 0, "pts":[], "r": [0.1, 0, -0.01], "sz": [0.04], "c":[
                        { "name": "rightUpperArm", "r": [0.1, 0, 0], "sz": [0.04], "c": [
                            { "name": "rightLowerArm", "r": [0.15, 0,0], "sz": [0.04], "c": [
                                { "name": "rightHand", "r": [0.1, 0,0], "sz": [0.025], "c": [
                                    { "name": "rightThumbProximal", "bo": 0, "pts":[], "r": [0.05, 0, -0.02], "ci": [3,0,0], "sz": [0.015], "c": [
                                    ...
                                    { "name": "rightIndexProximal", "bo": 0, "pts":[], "r": [0.095, 0, -0.025], "ci": [0,3,0], "sz": [0.008], "c": [
                                    ...
                                    { "name": "rightMiddleProximal", "bo": 0, "pts":[], "r": [0.1, 0, -0], "ci": [0,0,3], "sz": [0.008], "c": [
                                    ...
                                    { "name": "rightRingProximal", "bo": 0, "pts":[], "r": [0.09, 0, 0.02], "ci": [3,2,0], "sz": [0.008], "c": [
                                    ...
                                    { "name": "rightLittleProximal", "bo": 1, "pts":[], "r": [0.08, 0, 0.04], "ci": [3,3,0], "sz": [0.008], "c": [
